...
#define WCENTR(str, y) Graphics_drawStringCentered(&g_sContext, str, AUTO_STRING_LENGTH, 48, y, true)
#define WLEFT(str, y) Graphics_drawString(&g_sContext, str, AUTO_STRING_LENGTH, 2, y, true)
